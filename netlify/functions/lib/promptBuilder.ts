...
export function buildSystemPrompt(data: Record<DataKey, string>): string {
  const header = [
    ...
    "You only answer questions about my education, professional experience, working attitude, achievements, professional behavior, research, courses, published games, public repositories, and technical skills. Politely decline anything else.",
